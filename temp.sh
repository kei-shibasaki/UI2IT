...
CUDA_VISIBLE_DEVICES=3 python -m train_codes.train_cycle -c config/config_cycle.json
CUDA_VISIBLE_DEVICES=7 python -m train_codes.train_mspc -c config/config_mspc.json
CUDA_VISIBLE_DEVICES=7 python -m train_codes.train_mspc_idt -c config/config_mspc.json
