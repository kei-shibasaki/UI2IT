...
def train(opt_path):
    ...
    log_items_train = [
        'total_step','lr', 'loss_G_GA', 'loss_G_GTA', 'gta_tga_distance_G', 'loss_G_idt', 'loss_G_idt_pert', 'loss_G_GA_back', 'loss_G_GTA_back', 'gta_tga_distance_G_back', 'loss_G_idt_back', 'loss_G_idt_pert_back', 'loss_G',
        'loss_D_B', 'loss_D_GA', 'loss_D_TB', 'loss_D_GTA', 'gta_tga_distance_D', 'loss_pert_constraint_D', 'loss_D_B_back', 'loss_D_GA_back', 'loss_D_TB_back', 'loss_D_GTA_back', 'gta_tga_distance_D_back', 'loss_D'
    ]
    log_items_val = [
    ...
    for e in range(1, 42*opt.steps):
        for i, data in enumerate(train_loader):
            ...
            # Training G
            set_requires_grad([netD, netP, netD_back], False)
            netG.zero_grad()
            logits_GA = netD(GA_f)
            ...
            loss_G = loss_G_GA + loss_G_GTA + gta_tga_distance_G + loss_G_idt + loss_G_idt_pert + loss_G_GA_back + loss_G_GTA_back + gta_tga_distance_G_back + loss_G_idt_back + loss_G_idt_pert_back
            loss_G.backward()
            ...
            # Training D
            set_requires_grad([netD, netP, netD_back], True)
            netP.zero_grad()
            netD.zero_grad()
            netD_back.zero_grad()
            ...
            loss_D = loss_D_B + loss_D_GA + loss_D_TB + loss_D_GTA + gta_tga_distance_D + loss_pert_constraint_D + loss_D_B_back + loss_D_GA_back + loss_D_TB_back + loss_D_GTA_back + gta_tga_distance_D_back
