...
def train(opt_path):
    ...
    log_items_train = [
        'total_step','lr', 'loss_G_GA', 'loss_G_GTA', 'gta_tga_distance_G', 'loss_G_background_recons', 'loss_G_idt', 'loss_G',
    ...
    for e in range(1, 42*opt.steps):
        for i, data in enumerate(train_loader):
            ...
            loss_G = loss_G_GA + loss_G_GTA + gta_tga_distance_G + loss_G_background_recons + loss_G_idt
            loss_G.backward()
