...
def train(opt_path):
    ...
    log_items_train = [
        'total_step','lr', 'loss_G_GA', 'loss_G_GTA', 'gta_tga_distance_G', 'gta_tga_distance_G_mask', 'loss_G_TM_GA', 'loss_G_TM_GTA', 'loss_G_idt', 'loss_G_idt_pert', 'loss_G_idt_pert', 'loss_G_idt_mask', 'loss_G_idt_mask_pert', 'loss_G',
    ...
    for e in range(1, 42*opt.steps):
        for i, data in enumerate(train_loader):
            ...
            loss_G = loss_G_GA + loss_G_GTA + gta_tga_distance_G + gta_tga_distance_G_mask + loss_G_TM_GA + loss_G_TM_GTA + loss_G_idt + loss_G_idt_pert + loss_G_idt_pert + loss_G_idt_mask + loss_G_idt_mask_pert 
            loss_G.backward()
